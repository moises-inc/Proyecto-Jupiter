  ...
  if (redSectors.length > 0) {
    redSectors.forEach(s => {
      ...
      item.innerHTML = `
        ...
        <div class="action-desc">Riesgo ML al ${s.score_pct}%. Peligro: ${s.disaster_type}. Punto Máximo de Impacto: ${s.eta_impact}. Proyectado aluvión y anegamiento crítico.</div>
      `;
